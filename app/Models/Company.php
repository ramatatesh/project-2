...
class Company extends Model
{
    ...
    public function holidayPolicy(): HasMany
    {
        return $this->hasMany(HolidayPolicy::class);
    }

    public function evaluationPolicy(): HasMany
    {
        return $this->hasMany(EvaluationPolicy::class);
    }
