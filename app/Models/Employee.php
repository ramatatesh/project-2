...
class Employee extends Model
{
    ...
    public function overtimeRequests(): HasMany { return $this->hasMany(OvertimeRequest::class); }
    ...
    public function promotionRequests(): HasMany { return $this->hasMany(PromotionRequest::class); }
}
